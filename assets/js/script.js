...
function fetchCityWeather(city) {
  ...
  fetch(
    ...
    .then((forecast) => {
      ...
      let date1 = new Date(forecast.list[6].dt * 1000);
      localStorage.setItem('Day 1', date1.toDateString());
      ...
      let iconUrl1 =
        ...
        forecast.list[6].weather[0].icon +
        '.png';
      ...
      document.getElementById('firstDayHumidity').textContent =
        humidity1 + ' %';

      //////2-Day Forecast

      let date2 = new Date(forecast.list[14].dt * 1000);
      localStorage.setItem('Day 2', date2.toDateString());
      ...
      let iconUrl2 =
        'http://openweathermap.org/img/w/' +
        forecast.list[14].weather[0].icon +
        '.png';
      ...
      document.getElementById('secondDayHumidity').textContent =
        humidity2 + ' %';

      //////3-Day Forecast

      let date3 = new Date(forecast.list[22].dt * 1000);
      localStorage.setItem('Day 3', date3.toDateString());
      ...
      let iconUrl3 =
        'http://openweathermap.org/img/w/' +
        forecast.list[22].weather[0].icon +
        '.png';
      ...
      document.getElementById('thirdDayHumidity').textContent =
        humidity3 + ' %';

      //////4-Day Forecast

      let date4 = new Date(forecast.list[30].dt * 1000);
      localStorage.setItem('Day 4', date4.toDateString());
      ...
      let iconUrl4 =
        'http://openweathermap.org/img/w/' +
        forecast.list[30].weather[0].icon +
        '.png';
      ...
      document.getElementById('fourthDayHumidity').textContent =
        humidity4 + ' %';

      //////5-Day Forecast

      let date5 = new Date(forecast.list[38].dt * 1000);
      localStorage.setItem('Day 5', date5.toDateString());
      ...
      let iconUrl5 =
        'http://openweathermap.org/img/w/' +
        forecast.list[38].weather[0].icon +
        '.png';
      ...
      document.getElementById('fifthDayHumidity').textContent =
        humidity5 + ' %';
    });
}
...
secondBtn.addEventListener('click', () => {
  let city = secondBtn.textContent.toLowerCase();
  fetchCityWeather(city);
});
